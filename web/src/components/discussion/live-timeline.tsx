      ...
      <ScrollArea className="flex-1">
        <div className="px-4 py-3 space-y-0.5">
                ...
                <div key={entry.key} className="py-2">
                  <div
                    className={[
                      ...
                      isAssistant
                        ? "border-l-2 border-status-live bg-overlay-4"
                  ...
                  >
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      {entry.isStreaming && (
                        <i className="ph-fill ph-circle text-[6px] text-status-live animate-pulse" />
                      )}
                    </div>
          ...
          <div className="flex items-center gap-3 py-3">
            <div className="h-px flex-1 bg-status-live-a30" />
            <div className="flex items-center gap-1.5">
              <span className="w-2 h-2 rounded-full bg-status-live animate-pulse" />
              <span className="text-[11px] text-status-live font-medium">Now</span>
            </div>
            <div className="h-px flex-1 bg-status-live-a30" />
          </div>
